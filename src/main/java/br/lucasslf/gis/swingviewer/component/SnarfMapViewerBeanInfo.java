 ...
 * @author cy81
 */
public class SnarfMapViewerBeanInfo extends SimpleBeanInfo {

    // Bean descriptor//GEN-FIRST:BeanDescriptor
    /*lazy BeanDescriptor*/
    private static BeanDescriptor getBdescriptor(){
        BeanDescriptor beanDescriptor = new BeanDescriptor  ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class , null ); // NOI18N//GEN-HEADEREND:BeanDescriptor

        // Here you can add code for customizing the BeanDescriptor.

        return beanDescriptor;     }//GEN-LAST:BeanDescriptor
    // Property identifiers//GEN-FIRST:Properties
    private static final int PROPERTY_cursorPosition = 0;
    private static final int PROPERTY_eagerLoad = 1;
    ...
    private static PropertyDescriptor[] getPdescriptor(){
        ...
        try {
            properties[PROPERTY_cursorPosition] = new PropertyDescriptor ( "cursorPosition", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getCursorPosition", "setCursorPosition" ); // NOI18N
            properties[PROPERTY_cursorPosition].setBound ( true );
            properties[PROPERTY_eagerLoad] = new PropertyDescriptor ( "eagerLoad", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "isEagerLoad", "setEagerLoad" ); // NOI18N
            properties[PROPERTY_eagerLoad].setBound ( true );
            properties[PROPERTY_enabled] = new PropertyDescriptor ( "enabled", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "isEnabled", "setEnabled" ); // NOI18N
            properties[PROPERTY_height] = new PropertyDescriptor ( "height", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getHeight", null ); // NOI18N
            properties[PROPERTY_message] = new PropertyDescriptor ( "message", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getMessage", "setMessage" ); // NOI18N
            properties[PROPERTY_message].setBound ( true );
            properties[PROPERTY_name] = new PropertyDescriptor ( "name", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getName", "setName" ); // NOI18N
            properties[PROPERTY_opaque] = new PropertyDescriptor ( "opaque", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "isOpaque", "setOpaque" ); // NOI18N
            properties[PROPERTY_showing] = new PropertyDescriptor ( "showing", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "isShowing", null ); // NOI18N
            properties[PROPERTY_size] = new PropertyDescriptor ( "size", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getSize", "setSize" ); // NOI18N
            properties[PROPERTY_toolTipText] = new PropertyDescriptor ( "toolTipText", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getToolTipText", "setToolTipText" ); // NOI18N
            properties[PROPERTY_visible] = new PropertyDescriptor ( "visible", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "isVisible", "setVisible" ); // NOI18N
            properties[PROPERTY_width] = new PropertyDescriptor ( "width", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getWidth", null ); // NOI18N
            properties[PROPERTY_x] = new PropertyDescriptor ( "x", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getX", null ); // NOI18N
            properties[PROPERTY_y] = new PropertyDescriptor ( "y", br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "getY", null ); // NOI18N
        }
    ...
    private static EventSetDescriptor[] getEdescriptor(){
        ...
        try {
            eventSets[EVENT_ancestorListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "ancestorListener", javax.swing.event.AncestorListener.class, new String[] {"ancestorAdded", "ancestorRemoved", "ancestorMoved"}, "addAncestorListener", "removeAncestorListener" ); // NOI18N
            eventSets[EVENT_componentListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "componentListener", java.awt.event.ComponentListener.class, new String[] {"componentResized", "componentMoved", "componentShown", "componentHidden"}, "addComponentListener", "removeComponentListener" ); // NOI18N
            eventSets[EVENT_containerListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "containerListener", java.awt.event.ContainerListener.class, new String[] {"componentAdded", "componentRemoved"}, "addContainerListener", "removeContainerListener" ); // NOI18N
            eventSets[EVENT_focusListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "focusListener", java.awt.event.FocusListener.class, new String[] {"focusGained", "focusLost"}, "addFocusListener", "removeFocusListener" ); // NOI18N
            eventSets[EVENT_hierarchyBoundsListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "hierarchyBoundsListener", java.awt.event.HierarchyBoundsListener.class, new String[] {"ancestorMoved", "ancestorResized"}, "addHierarchyBoundsListener", "removeHierarchyBoundsListener" ); // NOI18N
            eventSets[EVENT_hierarchyListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "hierarchyListener", java.awt.event.HierarchyListener.class, new String[] {"hierarchyChanged"}, "addHierarchyListener", "removeHierarchyListener" ); // NOI18N
            eventSets[EVENT_inputMethodListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "inputMethodListener", java.awt.event.InputMethodListener.class, new String[] {"inputMethodTextChanged", "caretPositionChanged"}, "addInputMethodListener", "removeInputMethodListener" ); // NOI18N
            eventSets[EVENT_keyListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "keyListener", java.awt.event.KeyListener.class, new String[] {"keyTyped", "keyPressed", "keyReleased"}, "addKeyListener", "removeKeyListener" ); // NOI18N
            eventSets[EVENT_mouseListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "mouseListener", java.awt.event.MouseListener.class, new String[] {"mouseClicked", "mousePressed", "mouseReleased", "mouseEntered", "mouseExited"}, "addMouseListener", "removeMouseListener" ); // NOI18N
            eventSets[EVENT_mouseMotionListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "mouseMotionListener", java.awt.event.MouseMotionListener.class, new String[] {"mouseDragged", "mouseMoved"}, "addMouseMotionListener", "removeMouseMotionListener" ); // NOI18N
            eventSets[EVENT_mouseWheelListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "mouseWheelListener", java.awt.event.MouseWheelListener.class, new String[] {"mouseWheelMoved"}, "addMouseWheelListener", "removeMouseWheelListener" ); // NOI18N
            eventSets[EVENT_propertyChangeListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "propertyChangeListener", java.beans.PropertyChangeListener.class, new String[] {"propertyChange"}, "addPropertyChangeListener", "removePropertyChangeListener" ); // NOI18N
            eventSets[EVENT_vetoableChangeListener] = new EventSetDescriptor ( br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class, "vetoableChangeListener", java.beans.VetoableChangeListener.class, new String[] {"vetoableChange"}, "addVetoableChangeListener", "removeVetoableChangeListener" ); // NOI18N
        }
        catch(IntrospectionException e) {
            e.printStackTrace();
    ...
    private static MethodDescriptor[] getMdescriptor(){
        ...
        try {
            ...
            methods[METHOD_paint92] = new MethodDescriptor(br.lucasslf.gis.swingviewer.component.SnarfMapViewer.class.getMethod("paint", new Class[] {java.awt.Graphics.class})); // NOI18N
            ...
            methods[METHOD_updateUI140] = new MethodDescriptor(javax.swing.JComponent.class.getMethod("updateUI", new Class[] {})); // NOI18N
